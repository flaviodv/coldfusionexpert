          ...
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <cfif isDefined("request.isToolsSection") and request.isToolsSection>
                ...
                <cfoutput>
                <li class="nav-tools-mobile"><a href="/index.cfm"><i class="fas fa-arrow-left"></i> Volver al Inicio</a></li>
                <li class="nav-tools-mobile"><a href="/tools.cfm"<cfif local.mnCurrentFile eq 'tools.cfm'> class="active"</cfif>><i class="fas fa-toolbox"></i> Todas las Herramientas</a></li>
                <cfloop array="#request.toolCategories#" index="local.mnCat">
                  <li class="nav-tools-mobile nav-category-label">#local.mnCat.labelEs#</li>
                  <cfloop array="#request.toolOrder#" index="local.mnSlug">
                    ...
                    <cfif local.mnTool.category eq local.mnCat.slug>
                      <li class="nav-tools-mobile"><a href="/tools/#local.mnSlug#.cfm"<cfif local.mnCurrentFile eq local.mnSlug & '.cfm'> class="active"</cfif>>#local.mnTool.titleEs#</a></li>
                    </cfif>
                  </cfloop>
                </cfloop>
                </cfoutput>
