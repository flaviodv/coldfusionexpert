...
local.faqItems = local.isEs ? [
  {q: "¿Cuándo conviene usar HSL en lugar de HEX o RGB?", a: "HSL (Hue, Saturation, Lightness) es ideal cuando querés ajustar la luminosidad u oscuridad de un color o crear sistemas de diseño responsivos, ya que solo necesitas cambiar el porcentaje de Lightness sin recalcular los componentes de rojo, verde y azul."},
  {q: "¿Cómo extraigo la paleta de colores de una imagen o logo?", a: "Hacé clic en el botón Extraer de Imagen, elegí tu archivo (PNG, JPG, WebP) y la herramienta analizará la imagen mostrando los 8 colores principales con sus códigos HEX listos para copiar."}
] : [
  {q: "When should I use HSL instead of HEX or RGB?", a: "HSL (Hue, Saturation, Lightness) is ideal when you want to adjust lightness or darkness or design responsive design systems, as you only need to tweak the Lightness percentage without recalculating Red, Green, and Blue channels."},
  {q: "How do I extract a color palette from an image or logo?", a: "Click the Extract from Image button, upload your file (PNG, JPG, WebP), and the tool will sample the image and present the top 8 color swatches with 1-click HEX copy buttons."}
];
</cfscript>
<cfoutput>
