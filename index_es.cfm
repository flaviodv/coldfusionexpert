...
<html lang="es">
  ...
  <head>
    ...
    <meta name="twitter:description" content="Especialista Senior en ColdFusion/CFML, Lucee, SQL Server, AWS Cloud y Automatización con IA. Top Rated Plus en Upwork.">
      ...
      "@graph": [
...

        {
          ...
          "almaMater": [
            ...
            "Instituto Superior de Artes Multimedia Da Vinci"
...

        {
          ...
          "description": "Desarrollo de software a medida en ColdFusion y Lucee, automatización de procesos con Inteligencia Artificial, optimización SEO/GEO, administración AWS y cursos en vivo vía Zoom.",
            ...
            "itemListElement": [
...

              {
                ...
                "itemOffered": {
                  ...
                  "name": "Consultoría y Desarrollo ColdFusion / Lucee"
...

              {
                ...
                "itemOffered": {
                  ...
                  "name": "Soluciones de Automatización con IA (LLMs, RAG, Agentes)"
...

              {
                ...
                "itemOffered": {
                  ...
                  "name": "Optimización SEO Técnico & GEO (AI Engine Visibility)"
...

              {
                ...
                "itemOffered": {
                  ...
                  "name": "Administración de Servidores Cloud AWS & IIS"
...

        {
          ...
          "name": "Cursos & Capacitación en Vivo vía Zoom (ColdFusion, Lucee, AWS, IA & SEO)",



          "description": "Capacitación personalizada 1 a 1 y mentores para equipos de desarrollo en ColdFusion, Lucee, bases de datos, AWS, APIs de IA y automatización.",
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="copyright-text">
            ...
            <p>Copyright © 2026 Coldfusion Expert - Flavio Di Virgilio. Todos los derechos reservíados.</p>
  ...
  <a href="?lan=en" class="float-lang" title="Switch to English">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="54" height="54">
      ...
      <g clip-path="url(#circleClipUS)">
        ...
        <rect width="100" height="14.28" y="0" fill="#B22234"/>



        <rect width="100" height="14.28" y="14.28" fill="#FFFFFF"/>



        <rect width="100" height="14.28" y="28.56" fill="#B22234"/>



        <rect width="100" height="14.28" y="42.84" fill="#FFFFFF"/>



        <rect width="100" height="14.28" y="57.12" fill="#B22234"/>



        <rect width="100" height="14.28" y="71.4" fill="#FFFFFF"/>



        <rect width="100" height="14.32" y="85.68" fill="#B22234"/>



        <rect width="45" height="57.12" fill="#3C3B6E"/>
        ...
        <circle cx="33" cy="12" r="3" fill="#FFFFFF"/>



        <circle cx="22.5" cy="28.5" r="3" fill="#FFFFFF"/>



        <circle cx="12" cy="45" r="3" fill="#FFFFFF"/>



        <circle cx="33" cy="45" r="3" fill="#FFFFFF"/>
